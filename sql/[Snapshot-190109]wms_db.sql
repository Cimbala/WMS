...
CREATE TABLE `wms_order_delivery`  (
  ...
  `NUM` int(12) NOT NULL,
  `CUSTOMER_ADDR` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `DELIVERY_TIME` datetime(0) NOT NULL,
  `REMARK0` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `REMARK1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `wms_record_storage` VALUES (1001, 2101, 173);
